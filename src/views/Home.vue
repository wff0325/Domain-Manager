...
:root {
  ...
  --panel-misty-bg-color: rgba(255, 255, 255, 0.75);
  --panel-border-color: rgba(200, 200, 200, 0.4);
}
html.dark {
  ...
  --panel-misty-bg-color: rgba(25, 35, 45, 0.7);
  --panel-border-color: rgba(100, 100, 120, 0.5);
}

/* --- 修正：确保 Element Plus 组件能继承全局变量 --- */
.el-dialog, .el-drawer, .el-picker-panel, .el-select-dropdown {
    --el-bg-color: var(--panel-bg-color, #ffffff) !important;
}
html.dark .el-dialog, html.dark .el-drawer { --el-bg-color: #1e293b !important; } /* 加固对话框背景 */
</style>
...
/* Misty 面板 */
.panel-style-misty .header, .panel-style-misty .custom-table, .panel-style-misty .footer { backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); background-color: var(--panel-misty-bg-color); border-color: var(--panel-border-color); }

/* Solid 面板 */
.panel-style-solid .header, .panel-style-solid .custom-table, .panel-style-solid .footer { backdrop-filter: none; background-color: var(--panel-bg-color); border-color: #d0d5dd; }
html.dark .panel-style-solid .header, html.dark .panel-style-solid .custom-table, html.dark .panel-style-solid .footer { border-color: #334155; }
...
:deep(.el-table th), :deep(.el-table td) { border-color: var(--border-color) !important; background-color: transparent !important; }
...
html.dark .separator { color: #4b5563; }
